...
function addFilmPage(film) {
    row.innerHTML += 
    `<a href=/film/` + parseInt(film.kinopoisk_id) + `/ class="col-3 col-lg-1 animate__animated animate__fadeIn films-link">
        <div class="card text-white bg-dark mb-3" style="width: 6rem; height: 15rem;">
            <img style="max-width: 6rem; max-height: 15rem;" src="https://st.kp.yandex.net/images/film_iphone/iphone360_` + parseInt(film.kinopoisk_id) +  `.jpg" class="card-img-top">
            <div class="card-body">
